...
type
  ...
  public
    ...
    function AddCustomMenu(Parent, ItemName, Title, Reference, Prompt : string; HotKey : Char; CloseActivate : Boolean; ScriptOwner : TScript) : TTWXMenuItem;
  ...
  public
    constructor Create(MenuOwner : TModMenu; ItemName : string; OnActivate : TMenuEvent; Title, Prmpt : String; Key : Char); overload;
    constructor Create(MenuOwner : TModMenu; ItemName, Title, Prmpt : string; Key : Char); overload;
...
function TModMenu.AddCustomMenu(Parent, ItemName, Title, Reference, Prompt : string; HotKey : Char; CloseActivate : Boolean; ScriptOwner : TScript) : TTWXMenuItem;
begin
  Result := TTWXMenuItem.Create(Self, ItemName, Title, Prompt, HotKey);
...
constructor TTWXMenuItem.Create(MenuOwner : TModMenu; ItemName : string; OnActivate : TMenuEvent; Title, Prmpt : String; Key : Char);
begin
  inherited Create;

  FController := MenuOwner;
  FTitle := Title;
  FHotKey := Key;
  ...
  MenuOwner.LinkMenu(Self);
end;

constructor TTWXMenuItem.Create(MenuOwner : TModMenu; ItemName, Title, Prmpt : String; Key : Char);
begin
